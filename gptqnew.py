...
stub.gptq_image = (
    ...
    .run_function(download_vic_13bx_model)
)
...
class ModalFalconGPTQ:
    ...
    def generate(self, prompt):
        ...
        output = self.model.generate(input_ids=tokens, max_new_tokens=512, do_sample=True, temperature=0.8)
